<?php
/**
 * Art\'s First Custom Theme functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package Art\'s_First_Custom_Theme
 */
...
function custom_theme_setup() {
	/*
		...
		* If you're building a theme based on Art\'s First Custom Theme, use a find and replace
